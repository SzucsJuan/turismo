...
const PaqueteDetalle = () => {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-12 font-sans">
      <button
        onClick={() => navigate(-1)}
        className="text-lg text-gray-600 font-nunito hover:text-gray-900 transition mb-8 flex items-center gap-2"
      >
        ← Volver
      </button>
      ...
      <div className="space-y-6 px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
          <div className="bg-gray-50 p-6 rounded-xl shadow">
            <h3 className="text-sm text-gray-500 font-nunito">Destino</h3>
            <p className="text-lg font-montserrat font-bold text-petroleo">
              {paquete.destino}
            </p>
          </div>
          <div className="bg-gray-50 p-6 rounded-xl shadow">
            <h3 className="text-sm text-gray-500 font-nunito">Duración</h3>
            <p className="text-lg font-montserrat font-bold text-petroleo">
        ...
        <div className="mt-12 bg-gray-50 p-8 rounded-2xl shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="#"
            className="flex items-center gap-3 bg-verde hover:bg-petroleo text-white px-6 py-3 rounded-full text-lg font-montserrat font-medium shadow-md transition"
          >
